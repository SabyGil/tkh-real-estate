...
export default class Filter extends Component {
  ...
  cities () {
    ...
    if(this.props.globalState.populateAction.cities !== undefined){
      let {cities}  = this.props.globalState.populateAction
  ...
  homeTypes (){
    if(this.props.globalState.populateAction.homeTypes !== undefined){
      let {homeTypes}  = this.props.globalState.populateAction
  ...
  bedrooms () {
    if(this.props.globalState.populateAction.bedrooms !== undefined){
      let {bedrooms}  = this.props.globalState.populateAction
